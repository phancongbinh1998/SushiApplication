...
<div class="content">
    <s:iterator value="listMap.keySet()" var="key">
        <div class="section">   
        <div class="content">
            <table class="table">
                <thead>
                    <tr>
                        <th>Menu <s:property value="listMap.get(#key).get(0).getMenuName()"/></th>
                                                <th class="align-right">Price</th>
                    </tr>
                </thead>
                <tbody>
                    <s:iterator value="listMap.get(#key)" var="sushi">
                    <tr>
                        <td><s:property value="title"/></td>
                        <td class="align-right"><s:property value="price"/></td>
              ...
              <p><s:property value="listMap.get(#key).get(0).getMenuDesc()"/>.</p>    
        </div>
    </div>
                </s:iterator>
